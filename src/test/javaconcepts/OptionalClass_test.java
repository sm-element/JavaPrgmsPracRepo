package test.javaconcepts;
	...
	public class OptionalClass_test {
		...
		//It is introduced in Java 8  band is similar to what Optional is in Guava.
		
	   public static void main(String args[]) {
		   OptionalClass_test java8Tester = new OptionalClass_test();
	      Integer value1 = null;
